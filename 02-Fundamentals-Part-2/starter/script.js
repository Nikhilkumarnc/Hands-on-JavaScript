...
// #---22. Iteration: For loop---

/* for (let rep = 1; rep <= 10; rep++) {
  console.log(`Lifting the weights repetition ${rep}`);
} */
...
// #23---continue and break---
// #23.1 continue

for (let i = 0; i < years.length; i++) {
  if (typeof jonasArray[i] !== "string") continue; // if not equal to string then skips
  console.log(`'continue': ` + types[i], typeof jonasArray[i]);
}

// #23.2 break
for (let i = 0; i < years.length; i++) {
  if (typeof jonasArray[i] === "number") break; // if not equal to string then skips
  console.log(`'break': ` + types[i], typeof jonasArray[i]);
} */
